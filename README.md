...
**Noticeboard Management:** Focal Persons can post News, Events, and Notifications.
...
**Setup XAMPP:** Move folder to C:/xampp/htdocs/.

**Database:** Import setup.sql into lms_db via phpMyAdmin.

**Run:** Open browser at http://localhost/your-folder.
